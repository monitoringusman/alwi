...
#offlines
arrLine3 = [100 - a for a in arrLine1]

line_chart = pygal.StackedLine(style=custom_style,show_dots=False,show_legend=False,range=(50, 100),x_label_rotation=270,fill=True)
line_chart.width = 850
line_chart.height = 250
line_chart.title = ""
line_chart.x_labels = arrLine2
line_chart.add('Online', arrLine1)
line_chart.add('Offline', arrLine3)
