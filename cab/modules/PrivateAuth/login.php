...

{
	...
	$query = "SELECT id, login, pass FROM png_users WHERE login='".$_POST['userlogin']."' LIMIT 1";
...
if($pass == md5(md5($_POST['password'])))
			...
			$message['message']="PRIVATEAUTH(CAB) INFO: Client IP = ".$_SERVER['REMOTE_ADDR']." succesfully auth LOGIN ".$_POST['userlogin'].".";
			...
			$_SESSION['hle_cab_hash']=$hash;

			header("Location: ".$globalSS['root_http']."cab/index.php"); exit();
		    ...
		    {
			//wrong password
			$message['message']="PRIVATEAUTH(CAB) INFO: Client IP = ".$_SERVER['REMOTE_ADDR']." ERROR AUTH LOGIN ".$_POST['userlogin'].".";
			doWriteToLogTable($globalSS,$message);
